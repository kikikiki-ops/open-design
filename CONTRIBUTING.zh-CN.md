...
> [!IMPORTANT]
> **当前活跃开发分支说明。** 如果你的 PR 属于这轮 **`0.8.0`** 的功能推进或修复，请从并且提到 [`preview/v0.8.0`](https://github.com/nexu-io/open-design/tree/preview/v0.8.0)，不要直接提到 `main`。`main` 继续作为稳定入口，但高速迭代中的 `0.8.0` 工作应先落在 preview 分支。
