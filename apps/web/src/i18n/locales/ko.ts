...
export const ko: Dict = {
  ...
  'updater.availableBody': 'Open Design {version}을 사용할 수 있습니다. 설치 전에 업데이트가 다운로드됩니다.',
  ...
  'updater.readyGeneric': '새 버전이 준비되었습니다. 최신 버전을 사용하려면 설치하세요.',
  'updater.readyVersion': 'Open Design {version}이 준비되었습니다. 최신 버전을 사용하려면 설치하세요.',
