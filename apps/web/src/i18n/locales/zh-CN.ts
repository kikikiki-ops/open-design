...
export const zhCN: Dict = {
  ...
  "messageCenter.actionToast": "Demo 操作已触发：{title}",
  "messageCenter.toastDismiss": "收起",
  ...
  "messageCenter.time.today": "今天",
  "messageCenter.time.yesterday": "昨天",
  "messageCenter.time.jun30": "6 月 30 日",
  "messageCenter.time.jun29": "6 月 29 日",
  "messageCenter.time.jun27": "6 月 27 日",
  "messageCenter.demo.release.title": "Open Design 0.13.0 可用",
  "messageCenter.demo.release.summary": "客户端启动和模型选择体验已优化。",
  "messageCenter.demo.release.body": "新版本减少了首次进入项目的等待感，并让模型能力标签更容易扫描。",
  "messageCenter.demo.release.action": "查看更新",
  "messageCenter.demo.teams.title": "Workspace for Teams 预览开放",
  "messageCenter.demo.teams.summary": "平台方可申请团队空间的早期体验。",
  "messageCenter.demo.teams.body": "团队空间会优先支持共享项目、成员权限和统一结算。当前 demo 仅展示消息中心入口。",
  "messageCenter.demo.teams.action": "了解团队空间",
  "messageCenter.demo.credits.title": "限时设计额度已发放",
  "messageCenter.demo.credits.summary": "符合条件的账户可获得一组试用额度。",
  "messageCenter.demo.credits.body": "额度可用于生成高保真页面、演示文稿和设计系统草案。实际发放以平台后台为准。",
  "messageCenter.demo.credits.action": "查看权益",
  "messageCenter.demo.maintenance.title": "今晚有一次短时维护",
  "messageCenter.demo.maintenance.summary": "模板市场和插件安装可能短暂不可用。",
  "messageCenter.demo.maintenance.body": "维护预计在 23:00 开始，影响时间约 20 分钟。正在运行的本地项目不受影响。",
  "messageCenter.demo.maintenance.action": "查看维护说明",
  "messageCenter.demo.templates.title": "新增 6 个发布物模板",
  "messageCenter.demo.templates.summary": "覆盖产品更新页、活动海报和投资人简报。",
  "messageCenter.demo.templates.body": "新模板会出现在模板库中，适合快速生成可编辑的首版草稿。",
  "messageCenter.demo.templates.action": "浏览模板",
