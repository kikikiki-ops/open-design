...
export const zhCN: Dict = {
  'task.step.search': '搜索了"{target}"',
  'task.step.searchDrilldown': '打开了 {target}',
  'task.step.read': '读取 {target}',
  'task.step.write': '创建 {target}',
  'task.step.edit': '编辑 {target}',
  'task.step.list': '列出 {target}',
  'task.step.command': '执行 {target}',
  'task.step.plan': '更新了计划',
  'task.step.outline': '整理大纲 {target}',
  'task.step.inspiration': '整理灵感 {target}',
  'task.step.generate': '生成 {target}',
  'task.step.thinking': '思考中',
  'task.step.tool': '调用 {tool}',
  'task.step.untitled': '内容',
  'task.computer.title': 'Computer',
  'task.computer.open': '打开 Computer',
  'task.computer.jumpToLive': '跳到实时',
  'task.computer.prevStep': '上一步',
  'task.computer.nextStep': '下一步',
  'task.computer.sideView': '侧栏视图',
  'task.computer.expand': '放大',
  'task.computer.close': '关闭',
  'task.computer.empty': '任务运行时,步骤会出现在这里',
  'task.computer.stepCount': '第 {current} / {total} 步',
  'task.computer.live': '实时',
  'task.status.completed': '任务已完成',
  'task.status.failed': '任务失败',
  'task.status.stopped': '已停止',
  'task.followUps.label': '建议的后续问题',
  'task.deliverable.label': '产物',
  'task.deliverable.open': '打开',
  ...
  "questions.useRecommended": "按推荐直接开始",
  "flow.title": "任务进度",
  "flow.stepOf": "第 {current} / {total} 步",
  "flow.stage.clarify": "Brief / 问题确认",
  "flow.stage.research": "搜索（可选）",
  "flow.stage.plan": "大纲",
  "flow.stage.inspire": "灵感",
  "flow.stage.generate": "实现",
  "flow.stage.deliver": "下载 / 分享",
  "flow.hint.clarify": "等待你的需求",
  "flow.hint.research": "需求确认后开始",
  "flow.hint.plan": "需求确认后生成",
  "flow.hint.inspire": "大纲确认后选择",
  "flow.hint.generate": "选定风格后开始",
  "flow.hint.deliver": "生成完成后可下载或分享",
  "flow.state.active": "进行中",
  "flow.state.complete": "已完成",
  "flow.state.skipped": "已跳过",
  "flow.state.error": "出错",
  "flow.unit.slides": "页",
  "flow.unit.sections": "个区块",
  "flow.unit.screens": "个屏幕",
  "flow.unit.pages": "个页面",
  "flow.unit.chapters": "章",
  "flow.unit.assets": "个素材",
  "flow.plan.unit.slide": "幻灯片",
  "flow.plan.unit.view": "视图",
  "flow.plan.unit.section": "区块",
  "flow.plan.unit.screen": "屏幕",
  "flow.plan.unit.page": "页面",
  "flow.plan.unit.chapter": "章节",
  "flow.plan.unit.asset": "素材",
  "flow.plan.titleLabel": "{unit}标题",
  "flow.plan.pointsLabel": "关键要点",
  "flow.plan.pointsHint": "每行填写一个关键要点。",
  "flow.plan.untitled": "未命名{unit}",
  "flow.plan.add": "添加{unit}",
  "flow.plan.insert": "插入{unit}",
  "flow.plan.moveUp": "上移",
  "flow.plan.moveDown": "下移",
  "flow.plan.empty": "添加一个{unit}以开始规划。",
  "flow.plan.saveError": "无法保存编辑后的方案",
  'flow.inspire.searchPlaceholder': '按风格或主题搜索',
  'flow.inspire.categoriesLabel': '模板分类',
  'flow.inspire.empty': '未找到匹配的模板。',
  'flow.inspire.rank': '排序',
  'flow.inspire.select': '选择',
  'flow.inspire.apply': '使用此风格',
  'flow.inspire.skip': '使用默认风格',
