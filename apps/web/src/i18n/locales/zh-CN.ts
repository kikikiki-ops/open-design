...
export const zhCN: Dict = {
  ...
  'designBrowser.status.pageSnapshotSaved': '已保存页面快照，资源 {saved}/{total}。',
  'designBrowser.status.downloadAssistHint': '第 2 步：在这里点击“下载页面”，等待页面快照保存成功，然后回到左侧“下一步”卡片点击“继续提取”。',
  'designBrowser.status.desktopDataUnavailable': '桌面浏览器数据在此不可用。',
  'designBrowser.status.browserDataCleared': '浏览器数据已清除。',
  'designBrowser.status.browserDataClearFailed': '浏览器数据清除失败。',
  'designBrowser.status.historyCleared': '历史记录已清空。',
  ...
  'chat.brandBrowserAssistMessage': 'Open Design 需要浏览器辅助才能完成这次品牌提取。用下方卡片打开 Browser，然后点击 More，选择“下载页面”，等待成功提示，再回到左侧“下一步”卡片继续提取。',
  ...
  'chat.brandBrowserAssistDownloadGuideDetails': '第 1 步：Browser 已打开。第 2 步：点击 More，再点击“下载页面”。第 3 步：等待页面快照保存成功提示。第 4 步：回到左侧“下一步”卡片，点击“继续提取”继续程序化抽取。',
  ...
  'artifact.odCardBrandAssistDone': '已打开浏览器',
  'artifact.odCardBrandAssistKicker': '需要浏览器辅助：{reason}',
  'artifact.odCardBrandAssistBody': '打开 Browser 并清除任何人机验证，然后点击 More，选择“下载页面”，等待页面快照保存成功，再回到左侧“下一步”卡片继续提取。',
