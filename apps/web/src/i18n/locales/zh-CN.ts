...
export const zhCN: Dict = {
  ...
  'chat.brandBrowserAssistMessage': 'Open Design 需要浏览器辅助才能完成这次品牌提取。用下方卡片打开 Browser，然后点击 More，选择“下载页面”，等待成功提示，再回到左侧“下一步”卡片继续提取。如果下方卡片没有出现，也可以手动打开右侧 Browser tab，按 More > 下载页面 > 继续提取 的路径操作。',
  ...
  'artifact.odCardBrandAssistBody': '打开 Browser 并清除任何人机验证，然后点击 More，选择“下载页面”，等待页面快照保存成功，再回到左侧“下一步”卡片继续提取。如果卡片没有出现，也可以手动打开右侧 Browser tab，按 More > 下载页面 > 继续提取 的路径操作。',
