...
export const zhCN: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} 可用。下载完成后即可安装更新。',
  ...
  'updater.ready': '更新已就绪',
  'updater.readyGeneric': '新版本已就绪。安装后即可使用最新版本。',
  'updater.readyVersion': 'Open Design {version} 已就绪。安装后即可使用最新版本。',
