...
export const zhCN: Dict = {
  ...
  "chat.contextUsage.estimated": "根据当前会话估算",
  "chat.contextUsage.providerMeasured": "已用最近一次模型用量校准",
  "chat.contextUsage.latestRun": "最近运行：输入 {input} / 输出 {output}",
  "chat.contextUsage.modelWindow": "模型窗口",
  "chat.contextUsage.estimatedWindow": "估算窗口",
  "chat.contextUsage.systemPrompt": "系统提示词",
  "chat.contextUsage.toolDefinitions": "工具定义",
  "chat.contextUsage.rules": "规则",
  "chat.contextUsage.skills": "技能",
  "chat.contextUsage.mcp": "MCP",
  "chat.contextUsage.designContext": "设计上下文",
  "chat.contextUsage.attachments": "附件",
  "chat.contextUsage.conversation": "会话",
  "chat.contextUsage.output": "输出",
  "chat.contextUsage.other": "其他",
  "chat.contextUsage.warningTitle": "上下文快满了",
  "chat.contextUsage.warningBody": "当前会话已使用 {percent}% / {limit} tokens。新建对话可以降低后续上下文成本，也可以继续当前会话。",
  "chat.contextUsage.autoCompactionWarningTitle": "上下文可能即将自动压缩",
  "chat.contextUsage.autoCompactionWarningBody": "当前会话已使用 {percent}% / {limit} tokens。当前 agent 支持自动压缩，压缩后占用可能会下降；也可以新建对话进一步降低后续上下文成本。",
  "chat.contextUsage.autoCompactionRunningTitle": "可能正在自动压缩上下文",
  "chat.contextUsage.autoCompactionRunningBody": "agent 运行时当前会话已使用 {percent}% / {limit} tokens。当前 agent 可能正在整理/压缩上下文，完成后占用通常会回落。",
  "chat.contextUsage.autoCompactionCompletedTitle": "上下文已自动压缩",
  "chat.contextUsage.autoCompactionCompletedBody": "自动压缩后，上下文占用已从 {beforePercent}% 降到 {percent}%。可以继续当前会话，也可以新建对话进一步降低后续上下文成本。",
  "chat.contextUsage.openPanel": "查看上下文用量",
  "chat.contextUsage.closePanel": "关闭上下文用量",
  "chat.you": "你",
  ...
  "modelCard.noDetails": "此模型暂无详细信息。",
  "modelCard.detailsAria": "模型详情：{model}",
  "modelCard.contextWindow": "{tokens} 上下文窗口",
  "modelCard.maxOutput": "{tokens} 最大输出",
  "modelCard.pricingInOut": "每百万 token 输入 {input} / 输出 {output}",
  "modelCard.pricingInputOnly": "每百万输入 token {input}",
  "modelCard.pricingOutputOnly": "每百万输出 token {output}",
  "modelCard.pricingCache": "缓存读取每百万 token {price}",
  "modelCard.speedFast": "快速",
  "modelCard.speedBalanced": "均衡",
  "modelCard.speedPowerful": "强大",
  "modelCard.recommendedFor": "适合",
  "modelCard.modeChat": "提问",
  "modelCard.modePlan": "规划",
  "modelCard.modeDesign": "设计",
  "modelCard.deprecated": "已弃用 — 建议改用更新的模型",
  "usagePanel.navTitle": "用量",
  "usagePanel.navHint": "费用、token 与余额",
  "usagePanel.subtitle":
    "查看每个模型、项目和会话的费用，以及你的 Open Design Cloud 余额。",
  "usagePanel.rangeAria": "用量时间范围",
  "usagePanel.rangeToday": "今天",
  "usagePanel.range7d": "7 天",
  "usagePanel.range30d": "30 天",
  "usagePanel.totalCost": "总费用",
  "usagePanel.totalTokens": "总 token 数",
  "usagePanel.runs": "运行次数",
  "usagePanel.costLegend": "$ 为服务商上报的费用 · ≈$ 为按目录价估算的费用",
  "usagePanel.cacheSavings": "缓存已节省约 {amount}",
  "usagePanel.cacheHitRatio": "缓存命中率 {percent}%",
  "usagePanel.tokensIn": "输入 {count}",
  "usagePanel.tokensOut": "输出 {count}",
  "usagePanel.breakdownAria": "用量明细",
  "usagePanel.groupModel": "按模型",
  "usagePanel.groupProject": "按项目",
  "usagePanel.groupConversation": "按会话",
  "usagePanel.groupDay": "按天",
  "usagePanel.bucketTokens": "{count} token",
  "usagePanel.bucketRuns": "{count} 次运行",
  "usagePanel.empty": "此时间段内暂无用量记录。运行一次 agent 后，费用会显示在这里。",
  "usagePanel.loadError": "无法加载用量数据。",
  "usagePanel.retry": "重试",
  "usagePanel.amrBlockTitle": "Open Design Cloud",
  "usagePanel.amrRecharge": "充值",
  "usagePanel.amrManage": "管理",
  "usagePanel.amrPromoBody":
    "登录 Open Design Cloud，即可在每次运行旁看到余额，并在同一处完成充值。",
  "usagePanel.avatarOpenUsage": "查看用量",
  "chatUsage.inTokens": "输入 {n}",
  "chatUsage.inTokensWithCache": "输入 {n}（缓存 {cache}）",
  "chatUsage.outTokens": "输出 {n}",
  "chatUsage.chipAria": "会话费用",
  "chatUsage.popoverTitle": "会话费用",
  "chatUsage.runCount": "{n} 次运行",
  "chatUsage.totalLabel": "合计",
  "chatUsage.noBreakdown": "暂无按模型的明细",
  "chatUsage.estimatedHint": "≈ 表示按目录价估算的费用",
  "advisor.dismissAria": "关闭建议",
  "advisor.contextHigh.message":
    "本次会话已用掉模型上下文窗口的 {percent}%。开启新会话可以保持回复质量。",
  "advisor.contextHigh.action": "开启新会话",
  "advisor.contextCritical.message":
    "上下文即将占满（{percent}%）。请在回复质量下降前开启新会话。",
  "advisor.modelOverkill.message":
    "最近的回复都比较简短 — 处理这类对话，{fast} 会比 {current} 更快也更省。",
  "advisor.modelUnderpowered.message":
    "设计类工作通常需要比 {current} 更强的模型，{powerful} 往往能产出更好的结果。",
  "advisor.modelSwitch.action": "切换到 {model}",
  "advisor.lowBalance.message":
    "你的 Open Design Cloud 余额不足（${balance}）。立即充值，避免运行中断。",
  "advisor.lowBalance.action": "充值",
};
