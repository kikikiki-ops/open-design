...
export const en: Dict = {
  ...
  'modelCard.noDetails': 'No details available for this model yet.',
  'modelCard.detailsAria': 'Model details: {model}',
  'modelCard.contextWindow': '{tokens} context window',
  'modelCard.maxOutput': '{tokens} max output',
  'modelCard.pricingInOut': '{input} / {output} per 1M tokens in/out',
  'modelCard.pricingInputOnly': '{input} per 1M input tokens',
  'modelCard.pricingOutputOnly': '{output} per 1M output tokens',
  'modelCard.pricingCache': 'Cache reads {price} per 1M tokens',
  'modelCard.speedFast': 'Fast',
  'modelCard.speedBalanced': 'Balanced',
  'modelCard.speedPowerful': 'Powerful',
  'modelCard.recommendedFor': 'Best for',
  'modelCard.modeChat': 'Ask',
  'modelCard.modePlan': 'Plan',
  'modelCard.modeDesign': 'Design',
  'modelCard.deprecated': 'Deprecated — consider a newer model',
  // Usage panel — cost/token/balance transparency dashboard
  'usagePanel.navTitle': 'Usage',
  'usagePanel.navHint': 'Cost, tokens & balance',
  'usagePanel.subtitle': 'See what each model, project, and conversation costs — and your Open Design Cloud balance.',
  'usagePanel.rangeAria': 'Usage time range',
  'usagePanel.rangeToday': 'Today',
  'usagePanel.range7d': '7 days',
  'usagePanel.range30d': '30 days',
  'usagePanel.totalCost': 'Total cost',
  'usagePanel.totalTokens': 'Total tokens',
  'usagePanel.runs': 'Runs',
  'usagePanel.costLegend': '$ reported by the provider · ≈$ estimated from catalog pricing',
  'usagePanel.cacheSavings': 'Saved by caching ≈{amount}',
  'usagePanel.cacheHitRatio': '{percent}% cache hit rate',
  'usagePanel.tokensIn': 'In {count}',
  'usagePanel.tokensOut': 'Out {count}',
  'usagePanel.breakdownAria': 'Usage breakdown',
  'usagePanel.groupModel': 'By model',
  'usagePanel.groupProject': 'By project',
  'usagePanel.groupConversation': 'By conversation',
  'usagePanel.groupDay': 'By day',
  'usagePanel.bucketTokens': '{count} tokens',
  'usagePanel.bucketRuns': '{count} runs',
  'usagePanel.empty': 'No usage recorded for this period yet. Run an agent and its cost will show up here.',
  'usagePanel.loadError': 'Could not load usage data.',
  'usagePanel.retry': 'Retry',
  'usagePanel.amrBlockTitle': 'Open Design Cloud',
  'usagePanel.amrRecharge': 'Recharge',
  'usagePanel.amrManage': 'Manage',
  'usagePanel.amrPromoBody': 'Sign in to Open Design Cloud to see your balance next to every run and top up in one place.',
  'usagePanel.avatarOpenUsage': 'View usage',
  ...
  'chatUsage.chipAria': 'Conversation cost',
  'chatUsage.popoverTitle': 'Conversation cost',
  'chatUsage.runCount': '{n} runs',
  'chatUsage.totalLabel': 'Total',
  'chatUsage.noBreakdown': 'No per-model breakdown yet',
  'chatUsage.estimatedHint': '≈ marks costs estimated from catalog pricing',
  // Advisor — context/model/balance suggestions in chat
  'advisor.dismissAria': 'Dismiss suggestion',
  'advisor.contextHigh.message': "This conversation has used {percent}% of the model's context window. A fresh session keeps replies sharp.",
  'advisor.contextHigh.action': 'Start new session',
  'advisor.contextCritical.message': 'Context is nearly full ({percent}%). Start a new session before replies degrade.',
  'advisor.modelOverkill.message': 'Recent replies have been short — {fast} would handle these turns faster and cheaper than {current}.',
  'advisor.modelUnderpowered.message': 'Design work usually needs more than {current}. {powerful} tends to produce stronger results.',
  'advisor.modelSwitch.action': 'Switch to {model}',
  'advisor.lowBalance.message': "Your Open Design Cloud balance is low (${balance}). Top up now so runs aren't interrupted.",
  'advisor.lowBalance.action': 'Recharge',
};
