...
export const en: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} is available. It will download before installation.',
  ...
  'updater.opening': 'Installing update...',
  ...
  'updater.readyGeneric': 'A new version is ready. Install it to use the latest version.',
  'updater.readyVersion': 'Open Design {version} is ready. Install it to use the latest version.',
