...
export const en: Dict = {
  ...
  'assistant.truncatedTitle': 'Response was cut off',
  'assistant.truncatedBody': 'This reached the model\'s output-length limit, so the file is incomplete. Continue and I\'ll finish it in place.',
  'assistant.truncatedContinue': 'Continue',
