...
export const en: Dict = {
  ...
  'task.step.outline': 'Prepared outline {target}',
  'task.step.inspiration': 'Prepared inspiration {target}',
  ...
  'chat.plus.mcp': 'MCP',
  'chat.plus.deepResearch': 'Deep research',
  ...
  'questions.useRecommended': 'Start with recommended',
  'flow.title': 'Task progress',
  'flow.stepOf': 'Step {current} of {total}',
  'flow.stage.clarify': 'Brief & questions',
  'flow.stage.research': 'Research (optional)',
  'flow.stage.plan': 'Outline',
  'flow.stage.inspire': 'Inspiration',
  'flow.stage.generate': 'Implement',
  'flow.stage.deliver': 'Download / share',
  'flow.hint.clarify': 'Waiting for your brief',
  'flow.hint.research': 'Starts after the brief is confirmed',
  'flow.hint.plan': 'Written after the brief is confirmed',
  'flow.hint.inspire': 'Pick after the outline is confirmed',
  'flow.hint.generate': 'Starts after choosing a direction',
  'flow.hint.deliver': 'Download or share when generation ends',
  'flow.state.active': 'In progress',
  'flow.state.complete': 'Done',
  'flow.state.skipped': 'Skipped',
  'flow.state.error': 'Error',
  'flow.unit.slides': 'slides',
  'flow.unit.sections': 'sections',
  'flow.unit.screens': 'screens',
  'flow.unit.pages': 'pages',
  'flow.unit.chapters': 'chapters',
  'flow.unit.assets': 'assets',
  'flow.plan.unit.slide': 'slide',
  'flow.plan.unit.view': 'view',
  'flow.plan.unit.section': 'section',
  'flow.plan.unit.screen': 'screen',
  'flow.plan.unit.page': 'page',
  'flow.plan.unit.chapter': 'chapter',
  'flow.plan.unit.asset': 'asset',
  'flow.plan.titleLabel': '{unit} title',
  'flow.plan.pointsLabel': 'Key points',
  'flow.plan.pointsHint': 'Put each key point on a separate line.',
  'flow.plan.untitled': 'Untitled {unit}',
  'flow.plan.add': 'Add {unit}',
  'flow.plan.insert': 'Insert {unit}',
  'flow.plan.moveUp': 'Move up',
  'flow.plan.moveDown': 'Move down',
  'flow.plan.empty': 'Add a {unit} to start the plan.',
  'flow.plan.saveError': 'Could not save the edited plan',
  'flow.inspire.searchPlaceholder': 'Search by style or topic',
  'flow.inspire.categoriesLabel': 'Template categories',
  'flow.inspire.empty': 'No matching templates found.',
  'flow.inspire.rank': 'Rank',
  'flow.inspire.select': 'Select',
  'flow.inspire.apply': 'Use this style',
  'flow.inspire.skip': 'Use the default style',
