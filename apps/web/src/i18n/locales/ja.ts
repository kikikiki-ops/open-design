...
export const ja: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} を利用できます。インストール前に更新をダウンロードします。',
  ...
  'updater.opening': '更新をインストールしています...',
  ...
  'updater.readyGeneric': '新しいバージョンの準備ができました。最新バージョンを使うにはインストールしてください。',
  'updater.readyVersion': 'Open Design {version} の準備ができました。最新バージョンを使うにはインストールしてください。',
