...
export const ptBR: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} está disponível. A atualização será baixada antes da instalação.',
  ...
  'updater.opening': 'Instalando atualização...',
  ...
  'updater.readyGeneric': 'Uma nova versão está pronta. Instale-a para usar a versão mais recente.',
  'updater.readyVersion': 'Open Design {version} está pronto. Instale-o para usar a versão mais recente.',
