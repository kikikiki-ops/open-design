...
export const pl: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} jest dostępny. Aktualizacja zostanie pobrana przed instalacją.',
  ...
  'updater.opening': 'Instalowanie aktualizacji...',
  ...
  'updater.readyGeneric': 'Nowa wersja jest gotowa. Zainstaluj ją, aby używać najnowszej wersji.',
  'updater.readyVersion': 'Open Design {version} jest gotowy. Zainstaluj go, aby używać najnowszej wersji.',
