...
export const it: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} è disponibile. L’aggiornamento verrà scaricato prima dell’installazione.',
  ...
  'updater.opening': 'Installazione aggiornamento...',
  ...
  'updater.readyGeneric': 'È pronta una nuova versione. Installala per usare la versione più recente.',
  'updater.readyVersion': 'Open Design {version} è pronto. Installalo per usare la versione più recente.',
