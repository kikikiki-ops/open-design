...
export const fa: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} موجود است. به‌روزرسانی پیش از نصب دانلود می‌شود.',
  ...
  'updater.opening': 'در حال نصب به‌روزرسانی...',
  ...
  'updater.readyGeneric': 'نسخه جدید آماده است. برای استفاده از آخرین نسخه آن را نصب کنید.',
  'updater.readyVersion': 'Open Design {version} آماده است. برای استفاده از آخرین نسخه آن را نصب کنید.',
