...
export const fa: Dict = {
  ...
  'modelCard.noDetails': 'هنوز جزئیاتی برای این مدل در دسترس نیست.',
  'modelCard.detailsAria': 'جزئیات مدل: {model}',
  'modelCard.contextWindow': 'پنجرهٔ زمینه {tokens}',
  'modelCard.maxOutput': 'حداکثر خروجی {tokens}',
  'modelCard.pricingInOut': '{input} / {output} به‌ازای هر ۱ میلیون توکن ورودی/خروجی',
  'modelCard.pricingInputOnly': '{input} به‌ازای هر ۱ میلیون توکن ورودی',
  'modelCard.pricingOutputOnly': '{output} به‌ازای هر ۱ میلیون توکن خروجی',
  'modelCard.pricingCache': 'خواندن از کش {price} به‌ازای هر ۱ میلیون توکن',
  'modelCard.speedFast': 'سریع',
  'modelCard.speedBalanced': 'متعادل',
  'modelCard.speedPowerful': 'قدرتمند',
  'modelCard.recommendedFor': 'مناسب برای',
  'modelCard.modeChat': 'پرسش',
  'modelCard.modePlan': 'برنامه‌ریزی',
  'modelCard.modeDesign': 'طراحی',
  'modelCard.deprecated': 'منسوخ‌شده — مدل جدیدتری را در نظر بگیرید',
  // Usage panel — cost/token/balance transparency dashboard
  'usagePanel.navTitle': 'مصرف',
  'usagePanel.navHint': 'هزینه، توکن و موجودی',
  'usagePanel.subtitle': 'ببینید هر مدل، پروژه و گفتگو چقدر هزینه دارد — همراه با موجودی Open Design Cloud شما.',
  'usagePanel.rangeAria': 'بازهٔ زمانی مصرف',
  'usagePanel.rangeToday': 'امروز',
  'usagePanel.range7d': '۷ روز',
  'usagePanel.range30d': '۳۰ روز',
  'usagePanel.totalCost': 'هزینهٔ کل',
  'usagePanel.totalTokens': 'مجموع توکن‌ها',
  'usagePanel.runs': 'اجراها',
  'usagePanel.costLegend': '$ گزارش‌شده توسط ارائه‌دهنده · ≈$ برآوردشده بر اساس قیمت کاتالوگ',
  'usagePanel.cacheSavings': 'صرفه‌جویی با کش ≈{amount}',
  'usagePanel.cacheHitRatio': '{percent}٪ نرخ اصابت کش',
  'usagePanel.tokensIn': 'ورودی {count}',
  'usagePanel.tokensOut': 'خروجی {count}',
  'usagePanel.breakdownAria': 'تفکیک مصرف',
  'usagePanel.groupModel': 'بر اساس مدل',
  'usagePanel.groupProject': 'بر اساس پروژه',
  'usagePanel.groupConversation': 'بر اساس گفتگو',
  'usagePanel.groupDay': 'بر اساس روز',
  'usagePanel.bucketTokens': '{count} توکن',
  'usagePanel.bucketRuns': '{count} اجرا',
  'usagePanel.empty': 'هنوز مصرفی برای این بازه ثبت نشده است. یک عامل را اجرا کنید تا هزینه‌اش اینجا نمایش داده شود.',
  'usagePanel.loadError': 'بارگیری داده‌های مصرف ممکن نشد.',
  'usagePanel.retry': 'تلاش دوباره',
  'usagePanel.amrBlockTitle': 'Open Design Cloud',
  'usagePanel.amrRecharge': 'شارژ',
  'usagePanel.amrManage': 'مدیریت',
  'usagePanel.amrPromoBody': 'برای دیدن موجودی در کنار هر اجرا و شارژ کردن در یک‌جا، وارد Open Design Cloud شوید.',
  'usagePanel.avatarOpenUsage': 'مشاهدهٔ مصرف',
  // Chat usage — per-conversation cost chip and popover
  'chatUsage.inTokens': 'ورودی {n}',
  'chatUsage.inTokensWithCache': 'ورودی {n} (کش {cache})',
  'chatUsage.outTokens': 'خروجی {n}',
  'chatUsage.chipAria': 'هزینهٔ گفتگو',
  'chatUsage.popoverTitle': 'هزینهٔ گفتگو',
  'chatUsage.runCount': '{n} اجرا',
  'chatUsage.totalLabel': 'مجموع',
  'chatUsage.noBreakdown': 'هنوز تفکیکی بر اساس مدل موجود نیست',
  'chatUsage.estimatedHint': 'علامت ≈ نشان‌دهندهٔ هزینه‌های برآوردشده بر اساس قیمت کاتالوگ است',
  // Advisor — context/model/balance suggestions in chat
  'advisor.dismissAria': 'رد کردن پیشنهاد',
  'advisor.contextHigh.message': 'این گفتگو {percent}٪ از پنجرهٔ زمینهٔ مدل را مصرف کرده است. شروع یک نشست تازه پاسخ‌ها را دقیق نگه می‌دارد.',
  'advisor.contextHigh.action': 'شروع نشست جدید',
  'advisor.contextCritical.message': 'زمینه تقریباً پر شده است ({percent}٪). پیش از افت کیفیت پاسخ‌ها، نشست جدیدی شروع کنید.',
  'advisor.modelOverkill.message': 'پاسخ‌های اخیر کوتاه بوده‌اند — {fast} این نوبت‌ها را سریع‌تر و ارزان‌تر از {current} انجام می‌دهد.',
  'advisor.modelUnderpowered.message': 'کارهای طراحی معمولاً به چیزی بیش از {current} نیاز دارند. {powerful} معمولاً نتایج قوی‌تری تولید می‌کند.',
  'advisor.modelSwitch.action': 'تغییر به {model}',
  'advisor.lowBalance.message': 'موجودی Open Design Cloud شما کم است (${balance}). همین حالا شارژ کنید تا اجراها قطع نشوند.',
  'advisor.lowBalance.action': 'شارژ',
};
