...
export const fa: Dict = {
  ...
  'assistant.truncatedTitle': 'پاسخ ناتمام ماند',
  'assistant.truncatedBody': 'به سقف طول خروجی مدل رسیدیم، بنابراین فایل ناقص است. روی «ادامه» بزنید تا همان فایل را کامل کنم.',
  'assistant.truncatedContinue': 'ادامه',
