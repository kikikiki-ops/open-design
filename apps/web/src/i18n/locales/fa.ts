...
export const fa: Dict = {
  'task.step.search': 'جست‌وجوی «{target}»',
  'task.step.searchDrilldown': '{target} باز شد',
  'task.step.read': '{target} خوانده شد',
  'task.step.write': '{target} ایجاد شد',
  'task.step.edit': '{target} ویرایش شد',
  'task.step.list': '{target} فهرست شد',
  'task.step.command': '{target} اجرا شد',
  'task.step.plan': 'برنامه به‌روزرسانی شد',
  'task.step.outline': 'طرح کلی {target} آماده شد',
  'task.step.inspiration': 'الهام {target} آماده شد',
  'task.step.generate': '{target} تولید شد',
  'task.step.thinking': 'در حال فکر کردن',
  'task.step.tool': '{tool} اجرا شد',
  'task.step.untitled': 'کار',
  'task.computer.title': 'Computer',
  'task.computer.open': 'باز کردن Computer',
  'task.computer.jumpToLive': 'رفتن به پخش زنده',
  'task.computer.prevStep': 'مرحله قبل',
  'task.computer.nextStep': 'مرحله بعد',
  'task.computer.sideView': 'نمای کناری',
  'task.computer.expand': 'بزرگ‌نمایی',
  'task.computer.close': 'بستن',
  'task.computer.empty': 'مراحل هنگام اجرای کار اینجا نمایش داده می‌شوند',
  'task.computer.stepCount': 'مرحله {current} از {total}',
  'task.computer.live': 'زنده',
  'task.status.completed': 'کار تکمیل شد',
  'task.status.failed': 'کار ناموفق بود',
  'task.status.stopped': 'متوقف شد',
  'task.followUps.label': 'پرسش‌های پیشنهادی بعدی',
  'task.deliverable.label': 'نتیجه',
  'task.deliverable.open': 'باز کردن',
  ...
  'chat.plus.mcp': 'MCP',
  'chat.plus.deepResearch': 'پژوهش عمیق',
  ...
  'questions.useRecommended': 'شروع با گزینهٔ پیشنهادی',
  'flow.title': 'پیشرفت کار',
  'flow.stepOf': 'مرحلهٔ {current} از {total}',
  'flow.stage.clarify': 'تأیید نیازمندی‌ها',
  'flow.stage.research': 'پژوهش (اختیاری)',
  'flow.stage.plan': 'طرح کلی',
  'flow.stage.inspire': 'الهام',
  'flow.stage.generate': 'پیاده‌سازی',
  'flow.stage.deliver': 'دانلود / اشتراک‌گذاری',
  'flow.hint.clarify': 'در انتظار نیازمندی‌های شما',
  'flow.hint.research': 'پس از تأیید نیازمندی‌ها آغاز می‌شود',
  'flow.hint.plan': 'پس از تأیید نیازمندی‌ها نوشته می‌شود',
  'flow.hint.inspire': 'پس از تأیید طرح انتخاب کنید',
  'flow.hint.generate': 'پس از انتخاب مسیر آغاز می‌شود',
  'flow.hint.deliver': 'پس از پایان تولید دانلود یا به اشتراک بگذارید',
  'flow.state.active': 'در حال انجام',
  'flow.state.complete': 'انجام شد',
  'flow.state.skipped': 'رد شد',
  'flow.state.error': 'خطا',
  'flow.unit.slides': 'اسلاید',
  'flow.unit.sections': 'بخش',
  'flow.unit.screens': 'اسکرین',
  'flow.unit.pages': 'صفحه',
  'flow.unit.chapters': 'فصل',
  'flow.unit.assets': 'دارایی',
  'flow.plan.unit.slide': 'اسلاید',
  'flow.plan.unit.view': 'نما',
  'flow.plan.unit.section': 'بخش',
  'flow.plan.unit.screen': 'صفحه',
  'flow.plan.unit.page': 'صفحه',
  'flow.plan.unit.chapter': 'فصل',
  'flow.plan.unit.asset': 'دارایی',
  'flow.plan.titleLabel': 'عنوان {unit}',
  'flow.plan.pointsLabel': 'نکات کلیدی',
  'flow.plan.pointsHint': 'هر نکتهٔ کلیدی را در یک خط جداگانه بنویسید.',
  'flow.plan.untitled': '{unit} بدون عنوان',
  'flow.plan.add': 'افزودن {unit}',
  'flow.plan.insert': 'درج {unit}',
  'flow.plan.moveUp': 'انتقال به بالا',
  'flow.plan.moveDown': 'انتقال به پایین',
  'flow.plan.empty': 'برای شروع طرح، یک {unit} اضافه کنید.',
  'flow.plan.saveError': 'ذخیرهٔ طرح ویرایش‌شده ممکن نشد',
  'flow.inspire.searchPlaceholder': 'جست‌وجو بر اساس سبک یا موضوع',
  'flow.inspire.categoriesLabel': 'دسته‌بندی قالب‌ها',
  'flow.inspire.empty': 'قالب مطابقی پیدا نشد.',
  'flow.inspire.rank': 'رتبه',
  'flow.inspire.select': 'انتخاب',
  'flow.inspire.apply': 'استفاده از این سبک',
  'flow.inspire.skip': 'استفاده از سبک پیش‌فرض',
