...
export const esES: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} está disponible. La actualización se descargará antes de instalarse.',
  ...
  'updater.opening': 'Instalando actualización...',
  ...
  'updater.readyGeneric': 'Hay una nueva versión lista. Instálala para usar la versión más reciente.',
  'updater.readyVersion': 'Open Design {version} está listo. Instálalo para usar la versión más reciente.',
