...
export const fr: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} est disponible. La mise à jour sera téléchargée avant l’installation.',
  ...
  'updater.opening': 'Installation de la mise à jour...',
  ...
  'updater.readyGeneric': 'Une nouvelle version est prête. Installez-la pour utiliser la dernière version.',
  'updater.readyVersion': 'Open Design {version} est prêt. Installez-le pour utiliser la dernière version.',
