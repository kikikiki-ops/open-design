...
export const zhTW: Dict = {
  ...
  "chat.contextUsage.title": "上下文用量",
  "chat.contextUsage.fullLabel": "已用 {percent}%",
  "chat.contextUsage.estimated": "根據目前會話估算",
  "chat.contextUsage.providerMeasured": "已用最近一次模型用量校準",
  "chat.contextUsage.latestRun": "最近執行：輸入 {input} / 輸出 {output}",
  "chat.contextUsage.modelWindow": "模型視窗",
  "chat.contextUsage.estimatedWindow": "估算視窗",
  "chat.contextUsage.systemPrompt": "系統提示詞",
  "chat.contextUsage.toolDefinitions": "工具定義",
  "chat.contextUsage.rules": "規則",
  "chat.contextUsage.skills": "技能",
  "chat.contextUsage.mcp": "MCP",
  "chat.contextUsage.designContext": "設計上下文",
  "chat.contextUsage.attachments": "附件",
  "chat.contextUsage.conversation": "會話",
  "chat.contextUsage.output": "輸出",
  "chat.contextUsage.other": "其他",
  "chat.contextUsage.warningTitle": "上下文快滿了",
  "chat.contextUsage.warningBody": "目前會話已使用 {percent}% / {limit} tokens。新建對話可以降低後續上下文成本，也可以繼續目前會話。",
  "chat.contextUsage.autoCompactionWarningTitle": "上下文可能即將自動壓縮",
  "chat.contextUsage.autoCompactionWarningBody": "目前會話已使用 {percent}% / {limit} tokens。目前 agent 支援自動壓縮，壓縮後占用可能會下降；也可以新建對話進一步降低後續上下文成本。",
  "chat.contextUsage.autoCompactionRunningTitle": "可能正在自動壓縮上下文",
  "chat.contextUsage.autoCompactionRunningBody": "agent 執行時目前會話已使用 {percent}% / {limit} tokens。目前 agent 可能正在整理/壓縮上下文，完成後占用通常會回落。",
  "chat.contextUsage.autoCompactionCompletedTitle": "上下文已自動壓縮",
  "chat.contextUsage.autoCompactionCompletedBody": "自動壓縮後，上下文占用已從 {beforePercent}% 降到 {percent}%。可以繼續目前會話，也可以新建對話進一步降低後續上下文成本。",
  "chat.contextUsage.openPanel": "查看上下文用量",
  "chat.contextUsage.closePanel": "關閉上下文用量",
  "chat.you": "你",
  ...
  "modelCard.noDetails": "此模型暫無詳細資訊。",
  "modelCard.detailsAria": "模型詳細資訊：{model}",
  "modelCard.contextWindow": "{tokens} 上下文視窗",
  "modelCard.maxOutput": "{tokens} 最大輸出",
  "modelCard.pricingInOut": "每百萬 tokens 輸入 {input} / 輸出 {output}",
  "modelCard.pricingInputOnly": "每百萬輸入 tokens {input}",
  "modelCard.pricingOutputOnly": "每百萬輸出 tokens {output}",
  "modelCard.pricingCache": "快取讀取每百萬 tokens {price}",
  "modelCard.speedFast": "快速",
  "modelCard.speedBalanced": "均衡",
  "modelCard.speedPowerful": "強大",
  "modelCard.recommendedFor": "最適合",
  "modelCard.modeChat": "詢問",
  "modelCard.modePlan": "規劃",
  "modelCard.modeDesign": "設計",
  "modelCard.deprecated": "已棄用——建議改用較新的模型",
  // Usage panel — cost/token/balance transparency dashboard
  "usagePanel.navTitle": "用量",
  "usagePanel.navHint": "成本、tokens 與餘額",
  "usagePanel.subtitle":
    "查看每個模型、專案與對話的成本，以及你的 Open Design Cloud 餘額。",
  "usagePanel.rangeAria": "用量時間範圍",
  "usagePanel.rangeToday": "今天",
  "usagePanel.range7d": "7 天",
  "usagePanel.range30d": "30 天",
  "usagePanel.totalCost": "總成本",
  "usagePanel.totalTokens": "總 tokens",
  "usagePanel.runs": "執行次數",
  "usagePanel.costLegend": "$ 由供應商回報 · ≈$ 依模型價目估算",
  "usagePanel.cacheSavings": "快取節省 ≈{amount}",
  "usagePanel.cacheHitRatio": "快取命中率 {percent}%",
  "usagePanel.tokensIn": "輸入 {count}",
  "usagePanel.tokensOut": "輸出 {count}",
  "usagePanel.breakdownAria": "用量明細",
  "usagePanel.groupModel": "依模型",
  "usagePanel.groupProject": "依專案",
  "usagePanel.groupConversation": "依對話",
  "usagePanel.groupDay": "依日期",
  "usagePanel.bucketTokens": "{count} tokens",
  "usagePanel.bucketRuns": "{count} 次執行",
  "usagePanel.empty":
    "此期間尚無用量紀錄。執行 agent 後，成本會顯示在這裡。",
  "usagePanel.loadError": "無法載入用量資料。",
  "usagePanel.retry": "重試",
  "usagePanel.amrBlockTitle": "Open Design Cloud",
  "usagePanel.amrRecharge": "儲值",
  "usagePanel.amrManage": "管理",
  "usagePanel.amrPromoBody":
    "登入 Open Design Cloud，即可在每次執行旁看到餘額，並在同一處完成儲值。",
  "usagePanel.avatarOpenUsage": "查看用量",
  // Chat usage — per-conversation cost chip and popover
  "chatUsage.inTokens": "輸入 {n}",
  "chatUsage.inTokensWithCache": "輸入 {n}（快取 {cache}）",
  "chatUsage.outTokens": "輸出 {n}",
  "chatUsage.chipAria": "對話成本",
  "chatUsage.popoverTitle": "對話成本",
  "chatUsage.runCount": "{n} 次執行",
  "chatUsage.totalLabel": "總計",
  "chatUsage.noBreakdown": "尚無各模型的成本明細",
  "chatUsage.estimatedHint": "≈ 表示依模型價目估算的成本",
  // Advisor — context/model/balance suggestions in chat
  "advisor.dismissAria": "關閉建議",
  "advisor.contextHigh.message":
    "本對話已使用模型上下文視窗的 {percent}%。新建對話可讓回應保持精準。",
  "advisor.contextHigh.action": "新建對話",
  "advisor.contextCritical.message":
    "上下文即將用滿（{percent}%）。請在回應品質下降前新建對話。",
  "advisor.modelOverkill.message":
    "最近的回覆都比較簡短——處理這類對話，{fast} 會比 {current} 更快也更省成本。",
  "advisor.modelUnderpowered.message":
    "設計工作通常需要比 {current} 更強的模型，{powerful} 往往能產出更好的結果。",
  "advisor.modelSwitch.action": "切換到 {model}",
  "advisor.lowBalance.message":
    "你的 Open Design Cloud 餘額偏低（${balance}）。立即儲值，避免執行中斷。",
  "advisor.lowBalance.action": "儲值",
};
