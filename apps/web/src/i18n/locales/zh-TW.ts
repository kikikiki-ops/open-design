...
export const zhTW: Dict = {
  ...
  'common.untitled': '未命名',
  'designBrowser.savePageBrief': '儲存頁面簡報',
  'designBrowser.menu': '瀏覽器選單',
  ...
  'designBrowser.status.noUrlToCopy': '沒有可複製的 URL。',
  'designBrowser.status.urlCopied': 'URL 已複製。',
  'designBrowser.status.openHttpFirst': '請先開啟 http 或 https 頁面。',
  'designBrowser.status.openBeforeScreenshot': '請先開啟頁面再截圖。',
  'designBrowser.status.screenshotSaved': '截圖已儲存。',
  'designBrowser.status.screenshotFailed': '截圖失敗。',
  'designBrowser.status.openBeforeBrief': '請先開啟頁面再儲存簡報。',
  'designBrowser.status.briefSaveFailed': '頁面簡報儲存失敗。',
  ...
  'designBrowser.status.pageSnapshotSaved': '已儲存頁面快照，資源 {saved}/{total}。',
  'designBrowser.status.downloadAssistHint': '第 2 步：在這裡點擊「下載頁面」，等待頁面快照儲存成功，然後回到左側「下一步」卡片點擊「繼續擷取」。',
  'designBrowser.status.desktopDataUnavailable': '桌面瀏覽器資料在此不可用。',
  'designBrowser.status.browserDataCleared': '瀏覽器資料已清除。',
  'designBrowser.status.browserDataClearFailed': '瀏覽器資料清除失敗。',
  'designBrowser.status.historyCleared': '歷史紀錄已清空。',
  ...
  'chat.brandBrowserAssistMessage': 'Open Design 需要瀏覽器輔助才能完成這次品牌擷取。用下方卡片開啟 Browser，然後點擊 More，選擇「下載頁面」，等待成功提示，再回到左側「下一步」卡片繼續擷取。',
  ...
  'chat.brandBrowserAssistDownloadGuideDetails': '第 1 步：Browser 已開啟。第 2 步：點擊 More，再點擊「下載頁面」。第 3 步：等待頁面快照儲存成功提示。第 4 步：回到左側「下一步」卡片，點擊「繼續擷取」繼續程式化擷取。',
  ...
  'artifact.odCardBrandAssistDone': '已開啟瀏覽器',
  'artifact.odCardBrandAssistKicker': '需要瀏覽器輔助：{reason}',
  'artifact.odCardBrandAssistBody': '開啟 Browser 並清除任何人機驗證，然後點擊 More，選擇「下載頁面」，等待頁面快照儲存成功，再回到左側「下一步」卡片繼續擷取。',
