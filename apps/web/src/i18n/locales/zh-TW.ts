...
export const zhTW: Dict = {
  ...
  "messageCenter.actionToast": "Demo 操作已觸發：{title}",
  ...
  "messageCenter.demo.release.summary": "客戶端啟動和模型選擇體驗已優化。",
  "messageCenter.demo.release.body": "新版本減少了首次進入專案的等待感，並讓模型能力標籤更容易掃描。",
  "messageCenter.demo.release.action": "查看更新",
  "messageCenter.demo.teams.title": "Workspace for Teams 預覽開放",
  "messageCenter.demo.teams.summary": "平台方可申請團隊空間的早期體驗。",
  "messageCenter.demo.teams.body": "團隊空間會優先支援共享專案、成員權限和統一結算。當前 demo 僅展示消息中心入口。",
  "messageCenter.demo.teams.action": "了解團隊空間",
  "messageCenter.demo.credits.title": "限時設計額度已發放",
  "messageCenter.demo.credits.summary": "符合條件的帳戶可獲得一組試用額度。",
  "messageCenter.demo.credits.body": "額度可用於生成高保真頁面、簡報和設計系統草案。實際發放以平台後台為準。",
  "messageCenter.demo.credits.action": "查看權益",
  "messageCenter.demo.maintenance.title": "今晚有一次短時維護",
  "messageCenter.demo.maintenance.summary": "模板市場和外掛安裝可能短暫不可用。",
  "messageCenter.demo.maintenance.body": "維護預計在 23:00 開始，影響時間約 20 分鐘。正在執行的本機專案不受影響。",
  "messageCenter.demo.maintenance.action": "查看維護說明",
  "messageCenter.demo.templates.title": "新增 6 個發布物模板",
  "messageCenter.demo.templates.summary": "涵蓋產品更新頁、活動海報和投資人簡報。",
  "messageCenter.demo.templates.body": "新模板會出現在模板庫中，適合快速生成可編輯的首版草稿。",
  "messageCenter.demo.templates.action": "瀏覽模板",
