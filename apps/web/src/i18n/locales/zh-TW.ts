...
export const zhTW: Dict = {
  ...
  'chat.brandBrowserAssistMessage': 'Open Design 需要瀏覽器輔助才能完成這次品牌擷取。用下方卡片開啟 Browser，然後點擊 More，選擇「下載頁面」，等待成功提示，再回到左側「下一步」卡片繼續擷取。如果下方卡片沒有出現，也可以手動開啟右側 Browser tab，按 More > 下載頁面 > 繼續擷取 的路徑操作。',
  ...
  'artifact.odCardBrandAssistBody': '開啟 Browser 並清除任何人機驗證，然後點擊 More，選擇「下載頁面」，等待頁面快照儲存成功，再回到左側「下一步」卡片繼續擷取。如果卡片沒有出現，也可以手動開啟右側 Browser tab，按 More > 下載頁面 > 繼續擷取 的路徑操作。',
