...
export const zhTW: Dict = {
  'task.step.search': '搜尋了「{target}」',
  'task.step.searchDrilldown': '開啟了 {target}',
  'task.step.read': '讀取 {target}',
  'task.step.write': '建立 {target}',
  'task.step.edit': '編輯 {target}',
  'task.step.list': '列出 {target}',
  'task.step.command': '執行 {target}',
  'task.step.plan': '更新了計畫',
  'task.step.outline': '整理大綱 {target}',
  'task.step.inspiration': '整理靈感 {target}',
  'task.step.generate': '產生 {target}',
  'task.step.thinking': '思考中',
  'task.step.tool': '呼叫 {tool}',
  'task.step.untitled': '內容',
  'task.computer.title': 'Computer',
  'task.computer.open': '開啟 Computer',
  'task.computer.jumpToLive': '跳到即時',
  'task.computer.prevStep': '上一步',
  'task.computer.nextStep': '下一步',
  'task.computer.sideView': '側欄檢視',
  'task.computer.expand': '放大',
  'task.computer.close': '關閉',
  'task.computer.empty': '任務執行時,步驟會出現在這裡',
  'task.computer.stepCount': '第 {current} / {total} 步',
  'task.computer.live': '即時',
  'task.status.completed': '任務已完成',
  'task.status.failed': '任務失敗',
  'task.status.stopped': '已停止',
  'task.followUps.label': '建議的後續問題',
  'task.deliverable.label': '產物',
  'task.deliverable.open': '開啟',
  ...
  "questions.useRecommended": "依推薦直接開始",
  "flow.title": "任務進度",
  "flow.stepOf": "第 {current} / {total} 步",
  "flow.stage.clarify": "Brief / 問題確認",
  "flow.stage.research": "搜尋（可選）",
  "flow.stage.plan": "大綱",
  "flow.stage.inspire": "靈感",
  "flow.stage.generate": "實作",
  "flow.stage.deliver": "下載 / 分享",
  "flow.hint.clarify": "等待你的需求",
  "flow.hint.research": "需求確認後開始",
  "flow.hint.plan": "需求確認後產出",
  "flow.hint.inspire": "大綱確認後選擇",
  "flow.hint.generate": "選定風格後開始",
  "flow.hint.deliver": "生成完成後可下載或分享",
  "flow.state.active": "進行中",
  "flow.state.complete": "已完成",
  "flow.state.skipped": "已跳過",
  "flow.state.error": "出錯",
  "flow.unit.slides": "頁",
  "flow.unit.sections": "個區塊",
  "flow.unit.screens": "個畫面",
  "flow.unit.pages": "個頁面",
  "flow.unit.chapters": "章",
  "flow.unit.assets": "個素材",
  "flow.plan.unit.slide": "投影片",
  "flow.plan.unit.view": "視圖",
  "flow.plan.unit.section": "區塊",
  "flow.plan.unit.screen": "畫面",
  "flow.plan.unit.page": "頁面",
  "flow.plan.unit.chapter": "章節",
  "flow.plan.unit.asset": "素材",
  "flow.plan.titleLabel": "{unit}標題",
  "flow.plan.pointsLabel": "關鍵要點",
  "flow.plan.pointsHint": "每行填寫一個關鍵要點。",
  "flow.plan.untitled": "未命名{unit}",
  "flow.plan.add": "新增{unit}",
  "flow.plan.insert": "插入{unit}",
  "flow.plan.moveUp": "上移",
  "flow.plan.moveDown": "下移",
  "flow.plan.empty": "新增一個{unit}以開始規劃。",
  "flow.plan.saveError": "無法儲存編輯後的方案",
  'flow.inspire.searchPlaceholder': '依風格或主題搜尋',
  'flow.inspire.categoriesLabel': '範本分類',
  'flow.inspire.empty': '找不到相符的範本。',
  'flow.inspire.rank': '排序',
  'flow.inspire.select': '選擇',
  'flow.inspire.apply': '使用此風格',
  'flow.inspire.skip': '使用預設風格',
