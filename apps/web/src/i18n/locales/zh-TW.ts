...
export const zhTW: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} 可用。下載完成後即可安裝更新。',
  ...
  'updater.ready': '更新已就緒',
  'updater.readyGeneric': '新版本已就緒。安裝後即可使用最新版本。',
  'updater.readyVersion': 'Open Design {version} 已就緒。安裝後即可使用最新版本。',
