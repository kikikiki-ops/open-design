...
export const ru: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} доступен. Обновление будет загружено перед установкой.',
  ...
  'updater.opening': 'Установка обновления...',
  ...
  'updater.readyGeneric': 'Новая версия готова. Установите её, чтобы использовать последнюю версию.',
  'updater.readyVersion': 'Open Design {version} готов. Установите его, чтобы использовать последнюю версию.',
