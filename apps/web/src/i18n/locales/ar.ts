...
export const ar: Dict = {
  ...
  'updater.availableBody': 'Open Design {version} متوفر. سيتم تنزيل التحديث قبل التثبيت.',
  ...
  'updater.opening': 'جارٍ تثبيت التحديث...',
  ...
  'updater.readyGeneric': 'إصدار جديد جاهز. ثبّته لاستخدام أحدث إصدار.',
  'updater.readyVersion': 'Open Design {version} جاهز. ثبّته لاستخدام أحدث إصدار.',
