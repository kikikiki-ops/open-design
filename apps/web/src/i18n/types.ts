...
export interface Dict {
  ...
  'chat.contextUsage.fullLabel': string;
  'chat.contextUsage.estimated': string;
  'chat.contextUsage.providerMeasured': string;
  'chat.contextUsage.latestRun': string;
  ...
  'chat.contextUsage.mcp': string;
  'chat.contextUsage.designContext': string;
  'chat.contextUsage.attachments': string;
  'chat.contextUsage.conversation': string;
  'chat.contextUsage.output': string;
  'chat.contextUsage.other': string;
  'chat.contextUsage.warningTitle': string;
  'chat.contextUsage.warningBody': string;
  'chat.contextUsage.autoCompactionWarningTitle': string;
  'chat.contextUsage.autoCompactionWarningBody': string;
  'chat.contextUsage.autoCompactionRunningTitle': string;
  'chat.contextUsage.autoCompactionRunningBody': string;
  'chat.contextUsage.autoCompactionCompletedTitle': string;
  'chat.contextUsage.autoCompactionCompletedBody': string;
  'chat.contextUsage.openPanel': string;
  'chat.contextUsage.closePanel': string;
  'chat.you': string;
  ...
  'modelCard.noDetails': string;
  'modelCard.detailsAria': string;
  'modelCard.contextWindow': string;
  'modelCard.maxOutput': string;
  'modelCard.pricingInOut': string;
  'modelCard.pricingInputOnly': string;
  'modelCard.pricingOutputOnly': string;
  'modelCard.pricingCache': string;
  'modelCard.speedFast': string;
  'modelCard.speedBalanced': string;
  'modelCard.speedPowerful': string;
  'modelCard.recommendedFor': string;
  'modelCard.modeChat': string;
  'modelCard.modePlan': string;
  'modelCard.modeDesign': string;
  'modelCard.deprecated': string;
  // Usage panel — cost/token/balance transparency dashboard
  'usagePanel.navTitle': string;
  'usagePanel.navHint': string;
  'usagePanel.subtitle': string;
  'usagePanel.rangeAria': string;
  'usagePanel.rangeToday': string;
  'usagePanel.range7d': string;
  'usagePanel.range30d': string;
  'usagePanel.totalCost': string;
  'usagePanel.totalTokens': string;
  'usagePanel.runs': string;
  'usagePanel.costLegend': string;
  'usagePanel.cacheSavings': string;
  'usagePanel.cacheHitRatio': string;
  'usagePanel.tokensIn': string;
  'usagePanel.tokensOut': string;
  'usagePanel.breakdownAria': string;
  'usagePanel.groupModel': string;
  'usagePanel.groupProject': string;
  'usagePanel.groupConversation': string;
  'usagePanel.groupDay': string;
  'usagePanel.bucketTokens': string;
  'usagePanel.bucketRuns': string;
  'usagePanel.empty': string;
  'usagePanel.loadError': string;
  'usagePanel.retry': string;
  'usagePanel.amrBlockTitle': string;
  'usagePanel.amrRecharge': string;
  'usagePanel.amrManage': string;
  'usagePanel.amrPromoBody': string;
  'usagePanel.avatarOpenUsage': string;
  // Chat usage — per-conversation cost chip and popover
  'chatUsage.inTokens': string;
  'chatUsage.inTokensWithCache': string;
  'chatUsage.outTokens': string;
  'chatUsage.chipAria': string;
  'chatUsage.popoverTitle': string;
  'chatUsage.runCount': string;
  'chatUsage.totalLabel': string;
  'chatUsage.noBreakdown': string;
  'chatUsage.estimatedHint': string;
  // Advisor — context/model/balance suggestions in chat
  'advisor.dismissAria': string;
  'advisor.contextHigh.message': string;
  'advisor.contextHigh.action': string;
  'advisor.contextCritical.message': string;
  'advisor.modelOverkill.message': string;
  'advisor.modelUnderpowered.message': string;
  'advisor.modelSwitch.action': string;
  'advisor.lowBalance.message': string;
  'advisor.lowBalance.action': string;
}
