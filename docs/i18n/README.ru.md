...
| Агентно-нативный (работает в вашем CLI) | Только Anthropic | ❌ | Только облачный агент | **✅ 22 CLI + BYOK** |
...
od search-files "primary button"      # поиск файлов по проектам
od get-file design-systems/linear-app/DESIGN.md
od get-artifact <slug>                # последний отрендеренный артефакт
...
- [x] Демон + 22 адаптера CLI кодинг-агентов + реестр навыков + каталог дизайн-систем
...
<a href="https://github.com/nexu-io/open-design/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nexu-io/open-design&max=500&columns=20&anon=1&cache_bust=2026-07-15" alt="Контрибьюторы Open Design" />
</a>
...
<a href="https://star-history.com/#nexu-io/open-design&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=nexu-io/open-design&type=Date&theme=dark&cache_bust=2026-07-15" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=nexu-io/open-design&type=Date&cache_bust=2026-07-15" />
    <img alt="История звёзд Open Design" src="https://api.star-history.com/svg?repos=nexu-io/open-design&type=Date&cache_bust=2026-07-15" />
  </picture>
</a>
