...
- 第 1 张 → `cover` → `assets/bg-cover.svg`
- 第 2 张 → `content` → `assets/bg-content.svg`
- 第 3 张 → `closing` → `assets/bg-closing.svg`
...
三张背景图均不承担可编辑正文信息；Logo 继续通过独立 `assets/logo.svg` 组件渲染。
